document.addEventListener('DOMContentLoaded', function() {
    ...
    const allCourses = [
        { id: 'course-ai', title: 'Trí tuệ nhân tạo', author: 'TS: Đặng Ngọc Hoàng Thành', img: '../pic/Course1.png' },
        { id: 'course-oop', title: 'Lập trình hướng đối tượng', author: 'TS: Nguyễn Mạnh Tuấn', img: '../pic/Course2.png' },
        { id: 'course-web', title: 'Phát triển ứng dụng web', author: 'ThS: Hồ Thị Thanh Tuyến', img: '../pic/Course3.png' },
        { id: 'course-ui', title: 'Thiết kế giao diện', author: 'ThS: Nguyễn Thị Bích Ngọc', img: '../pic/Course4.png' },
        { id: 'course-data', title: 'Khai phá dữ liệu', author: 'TS: Nguyễn An Tế', img: '../pic/Course1.png' },
        { id: 'course-db', title: 'Cơ sở dữ liệu', author: 'ThS: Hồ Thị Thanh Tuyến', img: '../pic/Course2.png' },
    ];
    ...
    function createCourseCardHTML(course) {
        ...
        return `
            <a href="../html/course-detail.html" class="course-card-profile">
